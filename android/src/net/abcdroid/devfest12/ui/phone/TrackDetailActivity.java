...
package net.abcdroid.devfest12.ui.phone;
...
import net.abcdroid.devfest12.ui.SocialStreamActivity;
import net.abcdroid.devfest12.ui.SocialStreamFragment;
...
public class TrackDetailActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowVendors = !ScheduleContract.Tracks.CODELABS_TRACK_ID.equals(mTrackId) && !ScheduleContract.Tracks.TECH_TALK_TRACK_ID.equals(mTrackId);

        if (mShowVendors) {
            final ActionBar actionBar = getSupportActionBar();
            actionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_TABS);
            actionBar.addTab(actionBar.newTab().setText(R.string.title_sessions).setTabListener(this));
            //actionBar.addTab(actionBar.newTab().setText(R.string.title_vendors).setTabListener(this));
        }
        
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(TrackInfoHelperFragment.newFromTrackUri(mTrackUri), "track_info").commit();
        }
