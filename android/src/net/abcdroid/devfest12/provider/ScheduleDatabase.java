...
package net.abcdroid.devfest12.provider;

import net.abcdroid.devfest12.provider.ScheduleContract.AnnouncementsColumns;
import net.abcdroid.devfest12.provider.ScheduleContract.Blocks;
import net.abcdroid.devfest12.provider.ScheduleContract.BlocksColumns;
import net.abcdroid.devfest12.provider.ScheduleContract.Rooms;
import net.abcdroid.devfest12.provider.ScheduleContract.RoomsColumns;
import net.abcdroid.devfest12.provider.ScheduleContract.Sessions;
import net.abcdroid.devfest12.provider.ScheduleContract.SessionsColumns;
import net.abcdroid.devfest12.provider.ScheduleContract.Speakers;
import net.abcdroid.devfest12.provider.ScheduleContract.SpeakersColumns;
import net.abcdroid.devfest12.provider.ScheduleContract.SyncColumns;
import net.abcdroid.devfest12.provider.ScheduleContract.Tracks;
import net.abcdroid.devfest12.provider.ScheduleContract.TracksColumns;
import net.abcdroid.devfest12.provider.ScheduleContract.Vendors;
import net.abcdroid.devfest12.provider.ScheduleContract.VendorsColumns;
