...
package net.abcdroid.devfest12.appwidget;

import net.abcdroid.devfest12.R;
import net.abcdroid.devfest12.provider.ScheduleContract;
import net.abcdroid.devfest12.ui.HomeActivity;
import net.abcdroid.devfest12.ui.SessionLivestreamActivity;
...
public class MyScheduleWidgetProvider extends AppWidgetProvider {
    ...
    public static final String CLICK_ACTION =
            "net.abcdroid.devfest12.appwidget.action.CLICK";
    public static final String REFRESH_ACTION =
            "net.abcdroid.devfest12.appwidget.action.REFRESH";
    public static final String EXTRA_PERFORM_SYNC =
            "net.abcdroid.devfest12.appwidget.extra.PERFORM_SYNC";
